...
async (page) => {
 ...
 return 'PASS: workspace board, optional projects and toolbar filtering, shared WIP, immutable item comments, card attachments, GitLab link controls, multi-sprint persistence, concurrent active sprints, closure isolation/history, stale edits, archive/restore, six accessible responsive layouts.';
}
